...
Meteor.startup(() => {
  ...
  if (Menus.find().count() === 0) {
    [
      { type: "flavor", name: 'Hawaiian', price: 1.00 },
      { type: "flavor", name: 'Chicken Supreme', price: 1.00 },
      { type: "flavor", name: 'Super Supreme', price: 1.00 },
      { type: "flavor", name: 'Pepperoni', price: 1.00 },
      { type: "flavor", name: 'Veggie Lover\'s', price: 1.00 },
      { type: "flavor", name: 'Curry Chicken', price: 1.00 },
      { type: "flavor", name: 'BBQ Chunky Chic', price: 1.00 },
      { type: "flavor", name: 'Chic Ham \'N\' Shroom', price: 1.00 },
      { type: "flavor", name: 'Cheese \'N\' Chic', price: 1.00 },
      { type: "flavor", name: 'Simply Cheese', price: 1.00 },
      { type: "flavor", name: 'Ocean Delight', price: 1.00 },
      { type: "flavor", name: 'Very Beefy', price: 1.00 },
      { type: "flavor", name: 'Wild About Mushrooms', price: 1.00 },
      { type: "flavor", name: 'BBQ Chicken', price: 1.00 },
      { type: "flavor", name: 'The Four Cheese', price: 1.00 },
      { type: "flavor", name: 'Seafood Deluxe', price: 1.00 },
      { type: "flavor", name: 'Hawaiian Supreme', price: 1.00 },
